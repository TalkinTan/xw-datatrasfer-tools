...
public class TaskChoisePanel extends JPanel {
    ...
    private static JPanel linkDatasourcePanel;
    private static JPanel linkModulePanel;

    private static JPanel panelRightContent;

    public static JPanel panelDatasource;
    public static JPanel panelModule;

    /**
     * 构造
     */
    public TaskChoisePanel() {
        initialize();
        addComponent();
        addListener();
    }
